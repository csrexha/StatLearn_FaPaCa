...
- [`DESCRIPTION`](https://github.com/csrexha/StatLearn_FaPaCa/tree/master/DESCRIPTION):
  contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/csrexha/StatLearn_FaPaCa/tree/master/make.R):
  main R script to run the entire project

- [`R/`](https://github.com/csrexha/StatLearn_FaPaCa/tree/master/R):
...
Guidelines](https://github.com/csrexha/StatLearn_FaPaCa/blob/main/CONTRIBUTING.md).
